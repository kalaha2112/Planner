...
(() => {
  ...
  const MIN_STOP_HOURS = 5;                           // below this, a travel day was not really spent in that city
    ...
    computeDates(trip) {
      ...
      trip.stops.forEach((stop, i) => {
        ...
        /* A travel day is shared, but it only counts where you were there long
           enough to do anything with it. Land at 23:00 and the day was not
           yours in any useful sense; leave at 06:00 and neither was that one.
           MIN_STOP_HOURS is where the line sits. With no time on the leg there
           is nothing to judge, so the day stays. */
        const hoursOnArrival = (r.arriveLeg && r.arriveLeg.arr != null) ? 24 - r.arriveLeg.arr : null;
        const hoursOnDeparture = (r.departLeg && r.departLeg.dep != null) ? r.departLeg.dep : null;
