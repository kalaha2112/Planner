    ...
    renderPackBody(trip) {
      ...
      const slots = PACK_SLOTS.map((s, i) => {
        ...
        const iconHtml = photoIcon
          ? `<div class="pk-icon pk-icon--photo"><img src="${photoIcon}" alt="" draggable="false"></div>`
          : (maskIcon ? `<div class="pk-icon" style="-webkit-mask-image:url(${maskIcon});mask-image:url(${maskIcon})"></div>` : '');
