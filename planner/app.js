        ...
        const items = itemList.map((it, ii) => {
          ...
          <div class="mid">
            <div class="name-row">
              ...
              ${hasAddr ? `<a class="maps" href="https://maps.google.com/?q=${encodeURIComponent(geoQuery)}" target="_blank" rel="noopener" title="Open ${escA(geoQuery)} in Google Maps" aria-label="Open in Google Maps">↗</a>` : ''}
