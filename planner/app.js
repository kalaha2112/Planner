...
(() => {
  ...
  class Planner {
    ...
    /* ============================================================
       UNFOLD TO MAP — picking a trip unrolls the globe into the map.
       ...
       ============================================================ */
    _unfoldToMap() {
      const g = window.gsap, g3 = this._g3;
      if (!g || !g3 || !g3.built || this._unfolding) return false;
      if (window.matchMedia('(prefers-reduced-motion: reduce)').matches) return false;
      if (this._introParked) return false;             // map is already on screen
      ...
      // fly the canvas free of the intro so it can cross the page
