  ...
  class Planner {
    ...
    async _mountPackCase3D(bp) {
      ...
      const [closed, open] = await Promise.all([
        this._packArtMesh(T, PK_ART_CLOSED),
        this._packArtMesh(T, PK_ART_OPEN),
      ]);
      ...
      open.position.y = -.35;                     // the open drawing sits lower in its box
    ...
    _initGlobe3D(wrap) {
      ...
      const tick = (now) => {
        ...
        if (g3.halos) {
          ...
          if (g3.atmoMat) g3.atmoMat.uniforms.uStrength.value = .5 + pulse * .25;
        }
    ...
    _themeGlobe3D() {
      ...
      if (g3.atmoMat) g3.atmoMat.uniforms.uColor.value.copy(new T.Color(pick('--gold', '#C8901F')));
    ...
    _packScrub(g, scope) {
      ...
      g.to({}, {
        ease: 'none',
        scrollTrigger: {
          trigger: bp, start: 'top 88%', end: 'center 45%', scrub: .5,
          onUpdate: (self) => {
